...
import { createVenderKYC } from "../../../store/slices/vendorKYCSlice";
...
const CreateVendor = () => {
  ...
  const { materials, uoms } = useSelector((state) => state.vendorMaterials);
  ...
  const tabs = ["general", "control", "material"];
  const [activeTab, setActiveTab] = useState(() => {
    return localStorage.getItem("createVendorActiveTab") || "general";
  });

  useEffect(() => {
    localStorage.setItem("createVendorActiveTab", activeTab);
  }, [activeTab]);
  ...
  const goToNextTab = () => {
    ...
    if (index < tabs.length - 1) {
      ...
      localStorage.setItem("createVendorActiveTab", nextTab);
    }
  };
  ...
  const goToPrevTab = () => {
    ...
    if (index > 0) {
      ...
      localStorage.setItem("createVendorActiveTab", prevTab);
    }
  };
  ...
  const [vendorBankFormData, setVendorBankFormData] = useState({
    vendor: "",
    bank_name: "",
    account_holder_name: "",
    account_number: "",
  ...
  const getCityName = (id) => {
    ...
    return data ? data.city_name : "";
  };

  const handleInitialChange = (e) => {
    const { name, value } = e.target;
    setInitialVendorData({ ...initialVendorData, [name]: value });
  };
  ...
  const handleVendorBankChange = (e) => {
    const { name, value } = e.target;
    setVendorBankFormData({ ...vendorBankFormData, [name]: value });
  };

  const handleInitialSubmit = () => {
    if (
      !initialVendorData.company ||
      !initialVendorData.account_group ||
      !initialVendorData.vendor_code
    ) {
    ...
    setVendorFormData((prev) => ({
      ...prev,
      company: initialVendorData.company,
      account_group: initialVendorData.account_group,
      vendor_code: initialVendorData.vendor_code,
    }));
  ...
  const handleFinalSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("createVendorActiveTab", "material");
      setVendorMaterialFormData((prev) => ({
        ...prev,
        vendor: vendorId,
      }));
  ...
  const handleVendorBankSubmit = async (e) => {
    e.preventDefault();
    setActionType("Save");

    if (
      !createdVendorId ||
      !vendorBankFormData.bank_name ||
      !vendorBankFormData.account_holder_name ||
      !vendorBankFormData.account_number ||
      !vendorBankFormData.ifsc_swift_code ||
      !vendorBankFormData.bank_branch ||
      !vendorBankFormData.legal_name ||
      !vendorBankFormData.registration_number ||
      !vendorBankFormData.registered_address ||
      !vendorBankFormData.official_email ||
      !vendorBankFormData.phone_number ||
      !vendorBankFormData.signatory_name ||
      !vendorBankFormData.signatory_designation ||
      !vendorBankFormData.signatory_email ||
      !vendorBankFormData.signatory_phone
    ) {
      showTemporaryMessage("Please fill in all required fields!", "error");
      setTimeout(() => setActionType(""), 3000);
      return;
    ...
    try {
      ...
      const res = await dispatch(createVenderKYC(payload)).unwrap();
      ...
      if (res.status === 200 || res.status === 201) {
        ...
        showTemporaryMessage("Vendor Bank Details created successfully!");
        goToNextTab();
      } else if (res.status === 202) {
        setSavedSteps((prev) => ({
          ...prev,
        ...
        showTemporaryMessage("Vendor Bank Details create accepted!", "success");
        goToNextTab();
      } else {
        showTemporaryMessage("Unexpected response from server.", "error");
      }
      ...
      if (errorMessages.length > 0) {
        ...
        showTemporaryMessage(
          "Failed to create vendor control details!",
          "error",
        );
      }
    }
  ...
  return (
    <div className="flex h-screen">
        ...
        <div className="border border-gray-300 rounded px-4 py-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-x-4 gap-y-2">
            ...
            <div className="flex flex-col">
              ...
              <select
                name="account_group"
                value={vendorFormData.account_group}
                onChange={handleVendorChange}
                className="flex-1 w-full form-input"
              >
                <option value="">Select</option>
          ...
          <div className="mt-2 border-b border-gray-300 flex gap-4 text-sm font-medium overflow-x-auto py-1 rounded">
            {/* General Data */}
            <button
            ...
            {/* Control Data */}
            <button
              disabled={!savedSteps.general || savedSteps.control}
              onClick={() =>
                savedSteps.general &&
                !savedSteps.control &&
              ...
              className={`pb-1 ${
                activeTab === "control"
                  ? "border-b-2 border-amber-400 text-amber-500"
                  : !savedSteps.general || savedSteps.control
                    ? "text-gray-300 cursor-not-allowed"
                    : "text-gray-500 cursor-pointer"
              }`}
            >
            ...
            <button
              ...
              onClick={() => savedSteps.control && setActiveTab("material")}
              className={`pb-1 ${
                activeTab === "material"
                  ? "border-b-2 border-amber-400 text-amber-500"
                  : !savedSteps.control
          ...
          {activeTab === "general" && (
            <>
              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-2">
                <div className="flex flex-col">
                  <label className="form-label">
              ...
              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-2">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="bank_name"
                    value={vendorBankFormData.bank_name}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.account_holder_name}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="account_number"
                    value={vendorBankFormData.account_number}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.ifsc_swift_code}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="bank_branch"
                    value={vendorBankFormData.bank_branch}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.registration_number}
                    onChange={handleVendorBankChange}
                    placeholder="Enter GST Number (GSTIN)"
                    className="flex-1 w-full form-input"
                  />
                </div>
                <div className="flex flex-col">
                  ...
                  <select
                    name="is_msme"
                    value={vendorBankFormData.is_msme}
                    onChange={handleVendorBankChange}
                    className="flex-1 w-full form-input"
                  >
                    <option value="">Select</option>
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="legal_name"
                    value={vendorBankFormData.legal_name}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col col-span-2">
                  ...
                  <textarea
                    ...
                    value={vendorBankFormData.registered_address}
                    onChange={handleVendorChange}
                    rows={2}
                    className="flex-1 w-full textarea-input"
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="email"
                    name="official_email"
                    value={vendorBankFormData.official_email}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="phone_number"
                    value={vendorBankFormData.phone_number}
                    onChange={handleVendorBankChange}
                    placeholder="Enter Phone Number"
                    maxLength={10}
                    className="flex-1 w-full form-input"
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    name="signatory_name"
                    value={vendorBankFormData.signatory_name}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.signatory_designation}
                    onChange={handleVendorBankChange}
                    placeholder="Enter Signatory Name"
                    className="flex-1 w-full form-input"
                  />
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.signatory_email}
                    onChange={handleVendorBankChange}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    value={vendorBankFormData.signatory_phone}
                    onChange={handleVendorBankChange}
                    placeholder="Enter Signatory Phone Number"
                    maxLength={10}
                    className="flex-1 w-full form-input"
                  />
                </div>
      ...
      ${
                ...
                <table className="table-auto w-full text-sm text-gray-700">
                  <tbody>
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="w-3/5 py-1 text-left pl-4">
                        {vendorFormData?.account_group?.code || "--"} -{" "}
                        {vendorFormData?.account_group?.name || "--"}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="font-semibold w-2/5 py-1 text-left">
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="w-3/5 py-1 text-left pl-4">
                        {getCurrencyName(vendorFormData?.currency) || "--"}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="font-semibold w-2/5 py-1 text-left">
                      ...
                      <td className="w-3/5 py-1 text-left pl-4">
                        {getCountryName(vendorFormData?.country) || "--"}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="font-semibold w-2/5 py-1 text-left">
                      ...
                      <td className="w-3/5 py-1 text-left pl-4">
                        {getStateName(vendorFormData?.state) || "--"}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="font-semibold w-2/5 py-1 text-left">
                      ...
                      <td className="w-3/5 py-1 text-left pl-4">
                        {getCityName(vendorFormData?.city) || "--"}
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <td className="font-semibold w-2/5 py-1 text-left">
        ...
        {showInitialPopup && (
          <div className="fixed inset-0 backdrop-blur-[1px] flex justify-center items-center z-50">
            <div className="bg-white pt-0 pb-6 pl-6 pr-6 rounded-md w-11/12 max-w-sm border border-gray-300">
              <div className="flex justify-between items-center border-b-2 pb-2 mt-4 mb-4 border-gray-300">
                <div className="flex items-center gap-2">
                  <FiUsers className="text-amber-500 text-lg" />
                  <h2 className="text-lg font-semibold text-gray-700">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="flex items-center">
                    ...
                    <div className="w-full flex items-center gap-2">
                      <select
                        name="company"
                        value={initialVendorData.company}
                        onChange={handleInitialChange}
                        className="w-[140px] min-w-[140px] form-input"
                      >
                        <option value="">Select</option>
                        {companies.map((c) => (
                          <option key={c.company_code} value={c.company_code}>
                      ...
                      {initialVendorData.company && (
                        <span className="text-sm text-gray-600 max-w-[60px] truncate">
                          {
                            companies.find(
                              (c) =>
                                String(c.company_code) ===
                                String(initialVendorData.company),
                            )?.company_name
                          }
                        </span>
                      )}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="w-full flex items-center gap-2">
                      <select
                        name="account_group"
                        value={initialVendorData.account_group}
                        onChange={handleInitialChange}
                        className="w-[140px] min-w-[140px] form-input"
                      >
                        <option value="">Select</option>
                        ...
                        <span className="text-sm text-gray-600 max-w-[60px] truncate">
                          {
                            accountGroups.find(
                              (ag) =>
                                String(ag.id) ===
                                String(initialVendorData.account_group),
                            )?.name
                          }
                        </span>
                      )}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="w-full flex items-center gap-2">
                      <input
                        type="text"
                        name="vendor_code"
                        value={initialVendorData.vendor_code}
                        onChange={handleInitialChange}
                        placeholder="Enter Vendor Code"
                        className="w-[140px] min-w-[140px] form-input"
                      />
