...
import { createMaterialGroup } from "../../../store/slices/materialGroupSlice";
...
const CreateMaterialGroup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await dispatch(createMaterialGroup(submitData)).unwrap();
      if (res.status === 200 || res.status === 201) {
        showTemporaryMessage("Material Group created successfully!", "success");
      } else if (res.status === 202) {
        showTemporaryMessage("Material Group create accepted!", "success");
      } else {
      ...
      if (errorMessages.length > 0) {
        ...
        showTemporaryMessage("Failed to create material group!", "error");
      }
    }
...
export default CreateMaterialGroup;
